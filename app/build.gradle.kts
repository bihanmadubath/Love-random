...
android {
    ...
    defaultConfig {
        applicationId = "com.aistudio.loverandom.fa140"
        minSdk = 24
        targetSdk = 36
        versionCode = 1
        versionName = "1.0"
    ...
    signingConfigs {
        create("release") {
            // FIXED: Reads from ENV or gradle.properties both
            val keystorePath = System.getenv("KEYSTORE_PATH") 
                ?: (project.findProperty("MYAPP_UPLOAD_STORE_FILE") as String? ?: "${rootDir}/my-upload-key.jks")
